          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div class="flex">
              <p class={categoryDescription}>
                ...
                of documentation that records them as criminals rather than
                survivors
              </p>
            </div>
            <div class="flex">
            ...
            <div class="flex">
              <p class={categoryDescription}>
                ...
                that are as trauma-informed as possible and allow for relief
                from multiple types of crimes. It should be noted that no state
                ...
                or murder is not justified. If a victim cannot legally fight
                back to be free - how can they believe they have the right to be
                free?
              </p>
            </div>
            <div class="flex">
            ...
            <div class="flex">
              <p class={categoryDescription}>
                ...
                from multiple types of crimes that victims are forced to commit
                in trafficking situations would improve these states' standing.
              </p>
            </div>
            <div class="flex">
              <div class={categoryHeader}>
            ...
            <div class="flex">
              <p class={categoryDescription}>
                ...
                relief is framed is often victim-blaming - for instance,
                requiring that victims show clear proof beyond a shadow of a
                doubt that they were trafficked AND that their charges for
                things like prostitution, truancy, petty theft (e.g. stealing
                food to eat) must be proven to be linked to trafficking. In some
                cases victims must prove the ways that their traffickers
                controlled them - painful and traumatic experiences when all a
                victim wants is to be able to rebuild their lives
              </p>
            </div>
            <div class="flex">
              <div class={categoryHeader}>
            ...
            <div class="flex">
              <p class={categoryDescription}>
                These states have almost no civil relief for those charged
                and/or convicted of crimes that they committed while in their
                trafficking situation. In this case the law prosecutes the
                victim and causes them to be legally haunted by their past, in
                addition to the psychological, and sometimes physical, scars
                they must carry.
              </p>
            </div>
            <div class="flex">
