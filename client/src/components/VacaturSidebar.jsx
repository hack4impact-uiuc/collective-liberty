...
const VacaturSidebar = (props: Props) => {
    ...
    const setThreeVacaturColors = (value, setter) => {
        if (value === 'No') {
            setter(['bg-flamingo border-white border-2', 'bg-black', 'bg-gray-option'])
        }
        else if (value === 'Juvenile Only') {
            setter(['bg-black', 'bg-orange border-white border-2','bg-gray-option'])
        }
        else {
            setter(['bg-black', 'bg-gray-option', 'bg-offered border-white border-2'])
        }
    }
    ...
    return (
        <>
            ...
            <button onClick={onCivilClick} class="rounded bg-eclipse text-white mt-4 py-2 px-4 overflow-y-auto w-full" aria-label={civilVisible ? "shrink description" : "expand description"}>
                ...
                <div class="flex w-full my-2">
                        <div class={civilColors[0] + " w-1/2 inline-block px-2 py-1 text-center rounded "}>Unavailable</div>
                        <div class={civilColors[1] + " w-1/2 inline-block px-2 py-1 text-center rounded "}>Available</div>
                </div>
                {civilVisible &&
            ...
            <button onClick={onVacaturClick} class="rounded bg-eclipse text-white mt-4 py-2 px-4 overflow-y-auto" aria-label={vacaturVisible ? "shrink description" : "expand description"}>
                ...
                <div class="float-right flex">
                    <p class="inline-block mr-2 txt-silver">Learn More</p>
                    <div class="inline-block mt-0.5">
                        {vacaturVisible ? <box-icon name='minus-circle' color="#C4C4C4"></box-icon> : <box-icon name='plus-circle' color="#C4C4C4"></box-icon>}
                    </div>
                </div>
                <div class="flex w-full my-2">
                        <div class={vacaturColors[0] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Unavailable</div>
                        <div class={vacaturColors[1] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Juvenile Only</div>
                        <div class={vacaturColors[2] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Available</div>
                </div>
                {vacaturVisible &&
                    <p class="break-normal text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                }
            ...
            <button onClick={onClemencyClick} class="rounded bg-eclipse text-white mt-4 py-2 px-4 overflow-y-auto" aria-label={clemencyVisible ? "shrink description" : "expand description"}>
                ...
                <div class="float-right flex">
                    <p class="inline-block mr-2 txt-silver">Learn More</p>
                    <div class="inline-block mt-0.5">
                        {clemencyVisible ? <box-icon name='minus-circle' color="#C4C4C4"></box-icon> : <box-icon name='plus-circle' color="#C4C4C4"></box-icon>}
                    </div>
                </div>
                <div class="flex w-full my-2">
                        <div class={clemencyColors[0] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Unavailable</div>
                        <div class={clemencyColors[1] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Juvenile Only</div>
                        <div class={clemencyColors[2] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Available</div>
                </div>
                {clemencyVisible &&
                <p class="break-normal text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                }
            ...
            <button onClick={onExpungementClick} class="rounded bg-eclipse text-white mt-4 py-2 px-4 overflow-y-auto" aria-label={expungementVisible ? "shrink description" : "expand description"}>
                ...
                <div class="float-right flex">
                    <p class="inline-block mr-2 txt-silver">Learn More</p>
                    <div class="inline-block mt-0.5">
                        {expungementVisible ? <box-icon name='minus-circle' color="#C4C4C4"></box-icon> : <box-icon name='plus-circle' color="#C4C4C4"></box-icon>}
                    </div>
                </div>
                <div class="flex w-full my-2">
                        <div class={expungementColors[0] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Unavailable</div>
                        <div class={expungementColors[1] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Juvenile Only</div>
                        <div class={expungementColors[2] + " w-1/3 inline-block px-2 py-1 text-center rounded "}>Available</div>
                </div>
                {expungementVisible &&
                <p class="break-normal text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                }
