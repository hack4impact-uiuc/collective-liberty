...
const preprocessCSV = (incident) => {
  ...
  if (
    stateCounts[incident['Business State']] == null ||
    stateCounts[incident['Business State']] == undefined
  )
  ...
  if (
    cityCounts[incident['Business City']] == null ||
    cityCounts[incident['Business City']] == undefined
  )
  ...
  if (
    incidentCounts[incident['Content/Focus']] == null ||
    incidentCounts[incident['Content/Focus']] == undefined
  )
